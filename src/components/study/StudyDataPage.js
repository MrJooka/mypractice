...
class StudyDataPage extends Component {
  ...
  showTitle() {
    axios.get("api/book/get-booklist").then((res) => {
  ...
  sessionSaveBookIds = () => {
    ...
    sessionStorage.setItem(
      "book_ids",
      JSON.stringify(this.state.selected_book)
    );
      ...
      <>
        <div style={book_select_page_top}>
          ...
          <Button
            ...
            onClick={this.sessionSaveBookIds}
          >
            다음
          </Button>
        </div>
        <StudyDataDefaultList
