...
class CommentStackOverFlow extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
        ...
        <div className="post-layout" style={{ display: "grid", gridTemplateColumns: "max-content 1fr" }}>
          <div className="votecell post-layout--left" style={{ width: "auto", paddingRight: "16px", verticalAlign: "top", gridColumn: 1 }}>
            <div className="js-voting-container" style={{ color: "rgb(187, 192, 196)", flexDirection: "column", justifyContent: "center", alignItems: "stretch", display: "flex", margin: "-2px" }}>
              <button className="js-vote-up-btn" style={{ position: "relative", display: "inline-block", textAlign: "center", textDecoration: "none", padding: 0, border: "none", outline: "none", font: "unset", borderRadius: 0, color: "unset", background: "none", boxShadow: "none", margin: "2px" }}>
              ...
              <button className="js-vote-down-btn " style={{ position: "relative", display: "inline-block", textAlign: "center", textDecoration: "none", padding: 0, border: "none", outline: "none", font: "unset", borderRadius: 0, color: "unset", background: "none", boxShadow: "none", margin: "2px" }}>
              ...
              <a className="js-post-issue" href="/" style={{ paddingBottom: "6px", cursor: "pointer", position: "relative", display: "inline", textAlign: "center", textDecoration: "none", margin: "2px auto", paddingTop: "6px" }}>
          ...
          <div className="answercell post-layout--right" style={{ paddingRight: "16px", gridColumn: 2, width: "auto", minWidth: 0 }}>
            <div className="s-prose js-post-body" style={{ fontSize: "15px", lineHeight: 1.5, wordWrap: "break-word", width: "100%" }}>
              ...
              <p>With a sorted array, the condition data[c] = 128 is first false for a streak of values, then becomes true for all later values. That's easy to predict. With an unsorted array, you pay for the branching cost.</p>
            </div>
                ...
                <div className="grid--cell mr16" style={{ flex: "1 1 100px", margin: "4px 16px 4px 0" }}>
                  <div className="js-post-menu" style={{ paddingTop: "2px" }}>
                    <div className="grid d-flex gs8" style={{ display: "flex", flexWrap: "wrap", margin: "-4px" }}>
                      ...
                      <div className="grid--cell" style={{ margin: "4px" }}>
                        <button type="button" style={{ display: "inline", padding: 0, border: "none", outline: "none", borderRadius: 0, fontSize: "13px", background: "none", boxShadow: "none", textAlign: "inherit", textDecoration: "none", color: "#6a737c" }}>
                          Follow
                        </button>
                      </div>
                    </div>
                    ...
                    <div className="user-gravatar32" style={{ float: "left", width: "32px", height: "32px", borderRadius: "1px" }}>
                      <a href="/users/-1/community" style={{ textDecoration: "none" }}>
                        <div className="gravatar-wrapper-32" style={{ width: "32px", height: "32px", overflow: "hidden" }}>
                          <img src="https://www.gravatar.com/avatar/a007be5a61f6aa8f3e85ae2fc18dd66e?s=32&amp;d=identicon&amp;r=PG" alt="" width="32" height="32" className="bar-sm" style={{ borderRadius: "3px", margin: "0 auto" }} />
                        </div>
                      </a>
                    </div>
          ...
          <div className="post-layout--right js-post-comments-component" style={{ paddingRight: "16px", gridColumn: 2, width: "auto", minWidth: 0 }}>
            <div id="comments-11227877" className="comments js-comments-container" style={{ borderTopWidth: "1px", borderTopStyle: "solid", borderColor: "#e4e6e8", marginTop: "12px", paddingBottom: "10px", width: "100%", textAlign: "left" }}>
              <ul className="comments-list" style={{ listStyle: "none", display: "grid", gridTemplateColumns: "max-content 1fr", listStyleType: "none", margin: 0, padding: 0 }}>
                <li className="comment" style={{ display: "contents" }}>
                  <div className="js-comment-actions comment-actions" style={{ borderBottom: "1px solid #eff0f1", padding: "6px 0", paddingRight: "2px", flexShrink: 0, display: "grid", alignContent: "flex-start", gridTemplateColumns: "repeat(2, max-content)" }}>
                  ...
                  <div className="comment-text js-comment-text-and-form" style={{ verticalAlign: "text-top", lineHeight: 1.3, fontSize: "13px", flexGrow: 1, borderBottom: "1px solid #eff0f1", padding: "6px", minWidth: 0, flexBasis: 0 }}>
                    <div className="comment-body js-comment-edit-hide" style={{ wordWrap: "break-word" }}>
                      <span className="comment-copy">Does branch prediction work better on sorted arrays vs. arrays with different patterns? For example, for the array the next element in the array from the pattern is 80. Would this kind of array be sped up by branch prediction in which the next element is 80 here if the pattern is followed? Or does it usually only help with sorted arrays?</span>
