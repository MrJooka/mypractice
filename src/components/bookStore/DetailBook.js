                ...
                >
                  ...
                  >
                    <div
                      ...
                      `}
                    >
                      <img width="200" height="320" src={this.state.bookcover_medium} alt="Thumbnail"></img>
                      <button
                        css={css`
                          margin-top: 9px;
                        `}
...
// {
//   "_id" : ObjectId("60739c45ad7ba776d9cd73d1"),
//   "book_info" : {
//       "title" : "미술이야기",
//       "category" : [
//           "middleschool",
...
//       "author" : "이규현",
//       "publisher" : "살림 출판",
//       "intro_book" : "미술품 경매가 투자수단으로 각광 받고 있는 현 시점에서, 조선일보 미술담당 기자이자 세계 2대 경매회사 중 하나인 크리스티에서 대학원 과정을 졸업하기도 한 저자가 이 책을 통해 미술경매에 필요한 필수지식을 전한다. 하지만 저자는 여기서 그치지 않고, 역사에 기록될 유명 아트딜러들과 컬렉터들의 이야기를 함께 소개함으로써 단지 재테크에만 목적을 두는 것이 아닌 미술을 즐길 줄 아는 진정한 컬렉터가 되는 길로 독자들을 안내하고 있다.",
//       "intro_author" : "저자 - 이규현 전 조선일보 문화부 미술담당 기자로 서울디지털대학교 초빙교수(아트비즈니스 전공), 연세대, 중앙대 교양미술 강사활동을 했다. 연세대 국문학과 졸업했고, 중앙대 예술대학원 박물관미술관학과에서 미술이론 전공으로 석사학위 받았다. 그는 뉴욕 크리스티 경매회사에 있는 대학원 과정인 크리스티 에듀케이션(Christie’s Education)에서 Advanced Certificate 과정을 졸업했다. 미술경매의 전문가인 그는 자신이 정말 좋아하는 작품을 손에 넣게 된 미술애호가들의 그 행복한 순간들을 목격하고 기록한 것이다. 미술경매 취재를 시작하면서, \"아니, 일간지 기자가 경매장까지 취재를 오다니...\"라는 말을 듣곤 했다고 한다.  그의 저서로는 『그림쇼핑』이 있고, 논문으로는 「신문 미술기사의 특성과 시대별 기능변화 연구-해방 이후 한국종합일간지를 중심으로」가 있다.",
//       "indexes" : "프롤로그-즐거운 미술경매 미술경매 기초지식 미술경매의 현장들 역사에 남은, 역사에 남을 컬렉터들 역사에 남은, 역사에 남을 딜러들 경매의 스타 작가들에게는 다 이유가 있다 컬렉터 되어 보기",
//       "price" : 5000,
//       "promotion" : {
//           "name" : "",
//           "gap" : "undefined",
//           "period" : {
//               "from" : ISODate("1970-01-01T00:00:00.000Z"),
//               "to" : ISODate("1970-01-01T00:00:00.000Z")
//           }
//       },
//       "original_book_id" : ""
//   },
...
//   "cardtype_set" : [],
//   "cardinfo_set" : [],
//   "time_created" : ISODate("2021-04-12T01:03:01.924Z"),
//   "__v" : 0
// }

// {
//   "_id" : ObjectId("60739e56ad7ba776d9cd73d2"),
//   "book_info" : {
...
//   "cardtype_set" : [],
//   "cardinfo_set" : [],
//   "time_created" : ISODate("2021-04-12T01:11:50.931Z"),
//   "__v" : 0
// }

// {
//   "_id" : ObjectId("6073a01cad7ba776d9cd73d3"),
//   "book_info" : {
...
//   "cardtype_set" : [],
//   "cardinfo_set" : [],
//   "time_created" : ISODate("2021-04-12T01:19:24.514Z"),
//   "__v" : 0
// }

// {
//   "_id" : ObjectId("6073bc72ad7ba776d9cd73d4"),
//   "book_info" : {
//       "title" : "2021수능특강 영어통단어",
//       "category" : [
//           "highschool"
//       ],
//       "hashtag" : [
...
//       ],
//       "bookcover" : {
//           "url_original" : "https://bookcoverofcogbook.s3.ap-northeast-2.amazonaws.com/original/1618197609340english.png",
//           "url_small" : "https://bookcoverofcogbook.s3.ap-northeast-2.amazonaws.com/small/1618197609340english.png",
//           "url_medium" : "https://bookcoverofcogbook.s3.ap-northeast-2.amazonaws.com/medium/1618197609340english.png",
//           "url_large" : "https://bookcoverofcogbook.s3.ap-northeast-2.amazonaws.com/large/1618197609340english.png"
//       },
//       "author" : "조태웅",
//       "publisher" : "북랩 출판",
//       "intro_book" : "가볍게 쓰고, 동그라미 치고, 컬러풀하고 시원하게 단어와 표현을 자연스럽게 통으로 암기한다! 수능 영어 전문학원 ‘저스트원’ 조태웅 원장이 제시하는 효율 120% 수능 영단어 학습법   ⊙ 18년 동안 현장에서 『쓰다보면 암기되는 영단어』라는 이름으로 열렬한 호응을 받으며 이미 학생들의 충분한 검증을 받은 교재이다. ⊙ EBS 연계 교재 표현 속에서 단어를 암기하니 문맥상 이해가 훨씬 더 잘 된다. ⊙ 최소시간(5분 정도)에 한 페이지 평균 12개의 표현과 단어가 암기된다. ⊙ 한 페이지씩 쓰고, 동그라미 치면서 끝날 때마다 자신도 몰랐던 성취감이 생긴다.",
//       "intro_author" : "국적\t대한민국",
//       "indexes" : "",
//       "price" : 7900,
//       "promotion" : {
//           "name" : "",
...
//   "cardtype_set" : [],
//   "cardinfo_set" : [],
//   "time_created" : ISODate("2021-04-12T03:20:18.460Z"),
//   "__v" : 0
// }

// {
//   "_id" : ObjectId("6073be03ad7ba776d9cd73d5"),
//   "book_info" : {
//       "title" : "수능영어 100일의 기적",
//       "category" : [
//           "elementaryschool",
...
//       ],
//       "bookcover" : {
//           "url_original" : "https://bookcoverofcogbook.s3.ap-northeast-2.amazonaws.com/original/1618197907257highschoolenglish.png",
//           "url_small" : "https://bookcoverofcogbook.s3.ap-northeast-2.amazonaws.com/small/1618197907257highschoolenglish.png",
//           "url_medium" : "https://bookcoverofcogbook.s3.ap-northeast-2.amazonaws.com/medium/1618197907257highschoolenglish.png",
//           "url_large" : "https://bookcoverofcogbook.s3.ap-northeast-2.amazonaws.com/large/1618197907257highschoolenglish.png"
//       },
//       "hashtag" : [
//           "영어단어",
//           "수능특강",
...
//   "cardtype_set" : [],
//   "cardinfo_set" : [],
//   "time_created" : ISODate("2021-04-12T03:26:59.526Z"),
//   "__v" : 0
// }

// {
//   "_id" : ObjectId("6073c213fbbaa09d7968ddc1"),
//   "book_info" : {
//       "title" : "구술면접 380제",
//       "category" : [
//           "elementaryschool",
...
//       ],
//       "bookcover" : {
//           "url_original" : "https://bookcoverofcogbook.s3.ap-northeast-2.amazonaws.com/original/16181989857063.png",
//           "url_small" : "https://bookcoverofcogbook.s3.ap-northeast-2.amazonaws.com/small/16181989857063.png",
//           "url_medium" : "https://bookcoverofcogbook.s3.ap-northeast-2.amazonaws.com/medium/16181989857063.png",
//           "url_large" : "https://bookcoverofcogbook.s3.ap-northeast-2.amazonaws.com/large/16181989857063.png"
//       },
//       "hashtag" : [],
//       "author" : "이향우",
//       "publisher" : "콕북출판",
//       "intro_book" : "평소 교과서를 비롯해 다방면으로 독서를 하고 신문 및 뉴스를 접해 지적 능력을 길러야 한다. 그렇게 내공을 쌓다 보면 어떤 면접장에 가도 당당하게 말할 수 있을 것이다. - 저자의 말 중  비록 본인이 지금 많이 부족하다고 느낄지라도 늦었다고 생각했을 때가 가장 빠른 때인 만큼 지금부터 이 책을 통해 차근차근 준비해 나가길 바랍니다. - 서울대학교 서양사학과 졸업 이상만  현재 이슈가 되고 있는 사회 문제에도 관심을 갖고, 거기에 대해서 자신의 생각을 정리해 보는 것도 좋은 방법입니다. - 서울대학교 인문학부 졸업 이종훈  짧은 기간이나마 열심히 준비하기 위해서는 기본적인 준비서가 있어야 합니다. 아마도 그런 점에서 이 책은 여러분에게 단순한 지식뿐만 아니라 면접에 대처하는 용기 역시 불어넣어 줄 것입니다. - 서울대학교 자유전공학부 졸업 김호겸  면접은 마치 실전처럼 가상 연습을 해 보는 것이 많은 도움이 됩니다. 교수님 대신 카메라를 앞에 두고 구술을 해 본다든지 또는 친구들과 함께 역할을 나누어 실전처럼 연습을 해 본다든지 하면 실력을 부쩍 향상시킬 수 있습니다. - 서울대학교 전기컴퓨터공학부 졸업 장재명",
//       "intro_author" : "2009년 현재 숭실고등학교에서 국어 교사로 재직 중이며 22년 간의 교사 생활의 노하우로 연구부장을 맡아 학생들의 진학을 책임지고 있는 베테랑 교사이다. 숭실고등학교의 독서교육개선팀장 및 통합논술지도팀장을 역임하여 2007년 교과지도 모범교사상(서울시교육감), 2008년 교과지도 모범교사상(교육과학기술부장관)을 수상하였다. 그리고 2008년에는 연세대학교 모의논술고사의 현직교사 채점위원으로 활동하였다. 또한 입학사정관제와 관련하여 대학을 비롯해 중·고등학교 및 각종 기관에서 연수 및 특강을 했다.",
//       "indexes" : "〈부록〉 2020학년도 대학별 기출 문제 2019학년도 대학별 기출 문제 2018학년도 대학별 기출 문제 2017학년도 대학별 기출 문제 2016학년도 대학별 기출 문제 빈출 인성 면접 기출 문제 유형별 출제 0순위 질문  〈PART 1 면접 꿰뚫기 Q&A 70〉 CHAPTER 1 면접 준비하기 CHAPTER 2 학생부종합전형 면접 CHAPTER 3 면접의 태도와 방법 CHAPTER 4 면접 준비 방법 CHAPTER 5 면접관 면접하기  〈PART 2 면접 실전 연습〉 CHAPTER 1 인문 계열 Q&A 140 CHAPTER 2 자연 계열 Q&A 140 CHAPTER 3 최신 기출 및 기출 예상 계열 공통 Q&A 30",
//       "price" : 19000,
//       "promotion" : {
//           "name" : "봄맞이이벤트",
//           "gap" : "undefined",
//           "period" : {
//               "from" : ISODate("2021-04-08T00:00:00.000Z"),
//               "to" : ISODate("2021-05-06T00:00:00.000Z")
//           }
//       },
//       "original_book_id" : ""
//   },
...
//   "cardtype_set" : [],
//   "cardinfo_set" : [],
//   "time_created" : ISODate("2021-04-12T03:44:19.883Z"),
//   "__v" : 0
// }

// {
//   "_id" : ObjectId("6073c3fde46f627b2516ebf8"),
//   "book_info" : {
...
//       ],
//       "bookcover" : {
//           "url_original" : "https://bookcoverofcogbook.s3.ap-northeast-2.amazonaws.com/original/1618199428788developersaysno.png",
//           "url_small" : "https://bookcoverofcogbook.s3.ap-northeast-2.amazonaws.com/small/1618199428788developersaysno.png",
//           "url_medium" : "https://bookcoverofcogbook.s3.ap-northeast-2.amazonaws.com/medium/1618199428788developersaysno.png",
//           "url_large" : "https://bookcoverofcogbook.s3.ap-northeast-2.amazonaws.com/large/1618199428788developersaysno.png"
//       },
//       "hashtag" : [
//           "영어단어",
//           "수능특강",
...
//       "author" : "김중철, 김수지",
//       "publisher" : "디지털북스",
//       "intro_book" : "“개발하기 싫어서 안 된다고 말하는 게 아니다”  많은 IT 종사자들이 안 된다고 말하는 개발자로 인해 협업에 어려움을 겪는다. 우리는 IT 비전공자로서 소통을 잘하기 위해 개발자의 입장에서 많이 생각하게 됐고, 이 과정을 통해 개발자의 안 된다는 말에 담겨 있는 여러 가지 의미를 깨달았다. 이 책에는 우리의 성장 과정에서 발견한 협업 노하우들을 담아냈다.   “개발 언어를 잘 몰라도 협업을 잘할 수 있다”  개발자와의 협업은 외국인과의 대화와 닮은 점이 많다. 영어 시험 점수는 높은데 외국인과 대화를 못 하는 친구와 시험 점수가 높지 않아도 외국인과 대화를 잘하는 친구를 모두 만나본 적이 있을 것이다. 개발 언어는 영어 단어와 비슷하게 많이 알면 유리하지만 당장 협업에 써먹기는 어렵다. 개발 언어를 배우기 전에 꼭 먼저 알고 있어야 할 정보들에 대해 알아보자.    <추천사>  성공적인 프로덕트를 만들기 위해 가장 중요한 건 Makers와 협업하는 것입니다. 이 책은 '기획자, 디자이너, 개발자' 각자의 관점에서 어떻게 프로덕트를 바라보고, 진행하는지에 대해 저자의 경험 기반으로 쉽고 체계적으로 설명하고 있습니다. 특히 서비스를 사람의 신체 구조에 빗대어 시각화하여 설명한 부분이 인상적이었습니다. 이 책은 이제 막 IT 업계에 발 들인 신입에겐 '직무 이해도를 높여주고, 협업을 이해할 수 있는 좋은 길잡이 역할'을, 수년간의 경력이 있는 경력자에겐 'Makers 각자의 관점에서 프로덕트를 다시 바라보며 이해할 수 있는 시간'을 만들어 줄 거라고 생각합니다. IT 업계에서 프로덕트를 진행하며 협업에 어려움을 겪고 있거나 협업을 잘하기 위한 고민을 한 번이라도 해 본 사람이라면, 이 책을 꼭 읽어보시길 추천 드립니다.  야놀자 Product Owner 이미림   우선, IT 업계 실무자의 경험을 한 권의 책으로 풀어내어 매우 반갑습니다. 특히 문서로 말하는 기획자, 그림으로 표현하는 디자이너, 논리적인 개발자의 시선으로 바라본 지극히 현실적인 고충들이 아주 공감됩니다. 앞서서 이 책은 다양한 업무 분야와 사고방식을 가진 동료들과 협업하기 위해, 더 큰 시너지를 내기 위해, 행복하게 일하기 위해, 무엇을 해야 할지 구체적으로 제시하고 있습니다. 이 책을 읽으며, IT 업계에 첫발을 내디딘 주니어에겐 좋은 지침이 되길 바라고 시니어에겐 다시금 동료를 이해하는 시간이 되길 바랍니다.  쿠팡 UX Designer 배산하   개발자라는 직업으로 일을 하게 되면 여러 직무의 사람들과 함께 협업해야 하는 경우가 많습니다. 최근에는 코로나 19 바이러스까지 확산되어 비대면 협업이 일상이 되다 보니 여러 상황 속에서도 생산성을 높일 수 있는 협업의 중요성이 더욱 커지고 있습니다. 회의와 업무 등을 공유할 때, 개발자의 입장에서는 나름 쉽게 설명을 했지만, 오히려 더 큰 오해를 일으키기도 합니다. 이 책에서는 개발자가 전달하고 싶은 의도와 달리 잘못된 표현으로 인해 생기는 오해를 줄일 수 있도록 다양한 사례와 가이드라인을 제시해 주고 있기 때문에 기획자, 디자이너뿐만 아니라 개발자에게도 좋은 길라잡이가 될 것입니다. 「오늘도 개발자가 안 된다고 말했다」의 출간을 축하드리며, 이 책이 많은 분께 도움이 되길 기대합니다.  엔씨소프트 개발자 김청진   현 시대에는 프로그래밍만 잘해서 좋은 서비스를 만들 수 없습니다. 쉬움, 편함, 재미, 저렴함 등 다른 서비스보다 경쟁력이 있어야만 소비자의 선택을 받을 수 있는데, 경쟁력 있는 서비스를 만들기 위해서는 기획자, 디자이너, 개발자의 능력이 집중되어야 합니다. 그래서 협업은 서로를 이해하는 과정이 매우 중요합니다. 이 책에서는 직업별 업무의 특징을 이해하기 쉽게 정리하고 있어 서로를 이해하는 데 많은 도움을 얻을 수 있습니다. 저자들과 IT 협업 커뮤니티 ‘개기디마셔’에서 함께 활동하면서 협업의 어려움에 대한 공감대를 계속 형성해왔던 사람으로서 IT 업계에 종사하고 있는 분이라면, 이 책에 크게 공감하면서도 좋은 협업의 실마리를 찾을 수 있는 기회가 될 것입니다.  윤디자인 그룹, 에이아트 CTO 장종례",
//       "intro_author" : "저자: 김중철 / choel6721@gmail.com  성적 맞춰 지방의 한 대학교에서 행정학을 전공한 김해 촌놈이 우연히 IT 스타트업의 코파운더로 시작해서 상경했다가 망했다. 이후 서울에서 살아남으려고 3잡을 뛰다가 마케터의 길에 들어섰고 ‘답답하면 니들이 만들든가.’ 라는 말에 꽂혀 본격적으로 서비스 기획을 시작해, 현재는 기업가 정신을 널리 알리는 슈퍼 유니콘 스타트업 EO의 신규 플랫폼 PM으로 일하고 있다.    저자: 김수지 / sujji9@naver.com  사회복지를 전공했지만, 어릴 적 마음속에 담아 두었던 디자이너가 되고 싶어 전공을 살리지 않고 비전공자로 IT 업계에 뛰어들며 ‘개기디마셔’ IT 커뮤니티를 만들고 활동했다. 서비스를 통해 경험하고 성장하는 일을 좋아하는 디자이너 · 마케터에서 지금은 더 가슴 뛰는 일을 찾아 모든 경험을 살려 6차산업 사업을 하고 있다.",
//       "indexes" : "PART 01 가깝고도 먼 개발자  1. 어딘가 이상한 비전공자의 협업 - 기획자 김 군의 협업 - 디자이너 김 양의 협업 - 우리가 협업을 할 수 있었던 이유  2. 온몸으로 느낀 개발자 - 우리가 만난 세 가지 유형의 개발자 - 협업을 잘하는 개발자 - 개발자에게 하면 안 되는 말  3. 협업을 위한 준비물 - 원활한 협업을 위한 준비 - 개발 지식을 쌓는 순서   PART 02 기획자의 일  1. 서비스 기획 들여다보기 - 서비스 기획의 범위 - 인하우스와 에이전시의 기획자 - 이유와 기준이 있는 기획 - 시각화를 통한 최종 점검  2. 협업을 위한 사전 준비 - 전체를 한눈에 파악하는 IA - 웹 사이트의 계층 구조 이해 - 목적 중심의 벤치마킹  3. 협업을 돕는 화면 설계서 - 화면 설계서를 작성하는 이유 - 목적을 명확하게 전달하는 방법 - 설계서 타이틀의 중요성 - 스토리텔링을 위한 화면 설계서 - 리뷰를 요청하는 방법   PART 03 디자이너의 일  1. 디자이너의 마인드셋 - 디자인 기획 의도와 목적 - 웹/앱 디자인과 UI/UX 디자인 - 경쟁력을 갖춘 디자이너  2. 정확한 시각화를 위한 개발 지식 - 웹 디자인의 색상 - 이미지/영상 - 폰트 - 해상도 - 프로토타이핑  3. 협업을 위한 개발 지식 - 웹 표준과 웹 접근성 - 크로스 브라우징 - 크롬의 개발자 도구 - 레이아웃 - 모바일 웹 - 그리드 - 앱 디자인 고려하기 - 놓치기 쉬운 항목 체크하기   PART 04 개발자의 일  1. 개발자 이해하기 - 웹 개발자 - 모바일 개발자 - 소통에 필요한 개발 용어  2. 생산성 향상을 위한 협업 툴 - 커뮤니케이션 도구 - 기획자/디자이너의 협업 도구  3. 개발자가 말하는 협업 - 2년 차, 대기업 개발자 - 4년 차, 중소기업 개발자 - 6년 차, 프리랜서 개발자 - 10년 차, 에이전시 개발 CTO",
//       "price" : 15000,
//       "promotion" : {
//           "name" : "봄맞이이벤트",
//           "gap" : "undefined",
//           "period" : {
//               "from" : ISODate("2021-04-14T00:00:00.000Z"),
//               "to" : ISODate("2021-04-30T00:00:00.000Z")
//           }
//       },
//       "original_book_id" : ""
//   },
...
//   "cardtype_set" : [],
//   "cardinfo_set" : [],
//   "time_created" : ISODate("2021-04-12T03:52:29.818Z"),
//   "__v" : 0
// }

// {
//   "_id" : ObjectId("6073c53ce46f627b2516ebf9"),
//   "book_info" : {
//       "title" : "주린이가 가장 알고 싶은 최다질문77",
//       "category" : [
//           "elementaryschool",
//           "middleschool",
//           "japanese"
...
//   "cardtype_set" : [],
//   "cardinfo_set" : [],
//   "time_created" : ISODate("2021-04-12T03:57:48.343Z"),
//   "__v" : 0
// }

// {
//   "_id" : ObjectId("6073c62ce46f627b2516ebfa"),
//   "book_info" : {
//       "title" : "하룻밤에 읽는 한국사",
//       "category" : [
//           "elementaryschool",
...
//   "cardtype_set" : [],
//   "cardinfo_set" : [],
//   "time_created" : ISODate("2021-04-12T04:01:48.604Z"),
//   "__v" : 0
// }
